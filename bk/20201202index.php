...
<div class="page-wrapper page-wrapper-img">
    <div class="page-wrapper-inner-add align-items-center position-relative">
		...
		<div class="col-lg-8-add colxs-12 game-list table-responsive">
                        ...
                        <div class="col-12">
                            <div id="top_game_slider" class="top_game_slider">
                                <?php foreach($topdata as $data):?>
                                    ...
                                    <div class="row ml-0 mr-1">
                                        <div style="display: inline-block;padding: 0" class="col-12 col-md-5">
                                             <a href="./<?php echo($data->Store); ?>/<?php echo($data->NameSEO); ?>"><img src="<?php echo ($i_game[0]->Splash);?>" alt="<?php echo($data->Name);?>" /></a>
                                        </div>
                                            ...
                                            if(count($topdata_average)) {
                                                ...
                                                foreach($topdata_average as $data){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo number_format((float)$data->LastCcu)?></td>
                                                        <td class="text-center text-gray"><?php echo number_format((float)$data->MaxAvg24h)?></td>
                                                        <td class="text-center text-gray"><?php echo number_format((float)$data->MaxAvg30d)?></td>
                                                        <td class="text-center text-gray"><?php echo number_format((float)$data->MaxAvg)?></td>
                                                    </tr>
                                                    <?php
                                                }
                                            }
