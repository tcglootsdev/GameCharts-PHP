...
<table>
                        <tr>
                        <td  style="vertical-align:top;min-width:300px;min-height:1280px" class="desktop-add">
				<table>
					<tr>
						<td  style ="vertical-align:middle;min-height:620">
                                    ...
                                    <table class="table table-centered mb-0" style="overflow: hidden;">
                                        ...
                                        if(count($trending)) {
                                            ...
                                            foreach($trending as $data){
                                                ?>
                                                <tr>
                                                    <td><a class="text-dark" style="font-weight:500" href="./<?php echo $data['app_id']?>"><?php echo $data['name']?></a></td>
                                                    <td  class="text-success text-center font-weight-900"><?php echo $data['change']?></td>
                                                    <td>
                                                        <div class="chart-today" data-series='<?php echo json_encode($data['hist']) ?>'></div>
                                                    </td>
                                    ...
                                    <table class="table table-centered mb-0">
                                        ...
                                        if(count($topdata)) {
                                            ...
                                            foreach($topdata as $data){
                                                ...
                                                <tr>
                                                    <td><?php echo $index++?>.</td>
                                                    <td><a class="text-dark" style="font-weight:500" href="./<?php echo ($data->NameSEO); ?>"><?php echo $data->Name?></a></td>
                                                    <td class="center">
							<?php
                                                                if (isset($data['LastCcu'])) {
                                                                        echo number_format((float)$data['LastCcu']);
                                                                } else {
                                                                        echo "0";
                                                                }
                                                    ...
                                                    <td class="center text-gray">
							<?php
                                                                if (isset($data['TopCcu24h'])) {
                                                                        echo number_format((float)$data['TopCcu24h']);
                                                                } else {
                                                                        echo "0";
                                                                }
                                                    ...
                                                    <td class="center text-gray">
							<?php
                                                                if (isset($data['TopCcu30d'])) {
                                                                        echo number_format((float)$data['TopCcu30d']);
                                                                } else {
                                                                        echo "0";
                                                                }
                                                    ...
                                                    <td class="center text-gray">
							<?php
                                                                if (isset($data['TopCcu'])) {
                                                                        echo number_format((float)$data['TopCcu']);
                                                                } else {
                                                                        echo "0";
                                                                }
                    ...
                    <div class="row col-12" style="margin-top: 1em;">
                        <div class="card">
							...
							<?php
                                                    ...
                                                    <td class="center text-gray">
							<?php
                                                                if (isset($data['MaxAvg24h'])) {
                                                                        echo number_format((float)$data['MaxAvg24h']);
                                                                } else {
                                                                        echo "0";
                                                                }
                                                    ...
                                                    <td class="center text-gray">
							<?php
                                                                if (isset($data['MaxAvg30d'])) {
                                                                        echo number_format((float)$data['MaxAvg30d']);
                                                                } else {
                                                                        echo "0";
                                                                }
                                                    ...
                                                    <td class="center text-gray">
							<?php
                                                                if (isset($data['MaxAvg'])) {
                                                                        echo number_format((float)$data['MaxAvg']);
                                                                } else {
                                                                        echo "0";
                                                                }
