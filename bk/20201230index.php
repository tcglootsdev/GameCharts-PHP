            ...
            <div class="container-fluid-add px-0">
                ...
                <div class="row-add desktop-screen justify-content-center mb-5 pb-3" style="display:none;">
                    <div class="mobile-add">
                        <ins class="adsbygoogle" data-ad-client="ca-pub-2433076550762661"
...
?>
                                                        <tr>
                                                            <td><a class="text-dark"
                                                                    href="./<?php echo($data["store"])?>/<?php echo $data['app_id']?>"><?php echo $data['name']?></a>
                                                            </td>
                                                            <td><a
                                                                    href="./<?php echo($data["store"]); ?>"><img
                                                                        src="<?php echo($stores[$data["store"]]->Splash); ?>"
                                    ...
                                    <div id="trending_game_slider" class="trending_game_slider">
                                        ...
                                        <div class="row ml-0 mr-1">
                                            <div style="display: inline-block;padding: 0" class="col-12 col-md-5">
                                                <a
                                                    href="./<?php echo($data['store']); ?>/<?php echo($data['app_id']); ?>"><img
                                            ...
                                            foreach ($topdata as $data) {
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><a class="text-dark"
                                                                    href="./<?php echo($data->Store); ?>/<?php echo($data->NameSEO); ?>"><?php echo $data->Name?></a>
                                                            </td>
                                                            <td><a
                                                                    href="./<?php echo($data->Store); ?>"><img
                                                                        src="<?php echo($stores[$data->Store]->Splash); ?>"
                                ...
                                <div class="col-12">
                                    <div id="top_game_slider" class="top_game_slider">
                                        ...
                                        <div class="row ml-0 mr-1">
                                            <div style="display: inline-block;padding: 0" class="col-12 col-md-5">
                                                <a
                                                    href="./<?php echo($data->Store); ?>/<?php echo($data->NameSEO); ?>"><img
                                                        src="<?php echo($i_game[0]->Splash);?>"
                                                        alt="<?php echo($data->Name);?>" /></a>
                                            </div>
