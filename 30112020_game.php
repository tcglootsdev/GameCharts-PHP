<?php
    ...
    $stores = json_decode(file_get_contents('./data/store.json'));
...
<head>
    ...
    <meta property = "og:url" content="https://gamecharts.org/<?php echo "$source/$subFolder";?>"/>
...
<div class="row game-platforms">
        <span class="game-platforms-menu" style="margin-left: 0">
             ...
             foreach($stores as $store) {
                 if ($store->Store == $source){
                     echo('<li><a href="https://gamecharts.org/'.$store->Store.'"><img src="'.$store->Splash. '" alt="'.$store->Store.' logo"/></a> </li>');
                 }
             }
             ?>
        </span>
    <div class="route-top">
        ...
        <a href="https://gamecharts.org/<?php echo $source?>"><?php echo $source?></a>&nbsp;&nbsp;<i class="fas fa-angle-double-right"></i>&nbsp;&nbsp;<a href="#"><?php echo($gameinfo_aux[0]->Name); ?></a>
    </div>
</div>
...
-->
    ...
    <!--mobile-->
    <div class="row mobile-screen justify-content-center">
	<div class="row col-12">
        ...
        <div class="row col-12">
            <div id="global_mobile" class="game-card card p-3">
            </div>
        </div>
	<div class="row col-12">
            <ins class="adsbygoogle mobile-add-1"
	...
	-->
        <div class="row col-12" style="margin-top: 2em;">
            <div id="compare_mobile" class="game-card card p-3">
            </div>
        </div>
	<div class="row col-12">
            <ins class="adsbygoogle mobile-add-1"
	...
	-->
        <div class="row col-12" style="margin-top: 2em;">
            <div id="average_mobile" class="game-card card p-3">
            </div>
        </div>
	<div class="row col-12">
            <ins class="adsbygoogle mobile-add-1"
	...
	-->
        ...
        <div class="row">
                <div class="col-12">
                    <div id="top_game_slider_mobile" class="top_game_slider">
                        <div class="row ml-4">
                            <h2><?php echo($gameinfo_aux[0]->Name);?></h2>
...
<script>
    ...
    $( document ).ready(function() {
        ...
        Highcharts.stockChart('global_mobile', {
        ...
        Highcharts.stockChart('average_mobile', {
