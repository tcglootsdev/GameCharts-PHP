<footer class="section footer-classic context-dark bg-image" style="background: #2d3246;">
	<div class="social-footer">
		...
		Links
	<!--		<ul>
	                                <li class="fa-stack"><a href="https://www.facebook.com/Gamecharts-111747700514669/"><i class="fab fa-facebook-f"></i></a></li>
	                                <li class="fa-stack"><a href="https://www.instagram.com/gamechartsorg/"><i class="fab fa-instagram"></i></a></li>
	                                <li class="fa-stack"><a href="https://www.youtube.com/channel/UCBXUnqxAMX8NUZvmN6VlROA/"><i class="fab fa-youtube social-logo-resize"></i></a></li>
	                                <li class="fa-stack"><a href="https://twitter.com/Gamecharts1"><i class="fab fa-twitter"></i></a></li>
			</ul>
-->
		</div>
	</div>
