...
$_BACKGROUNDCOLOR = array('4' => '#104cff',
    '3.5' => '#3366d6', 
    '3' => '#3b76e5',
    '2.5' => '#4285f4', 
    '2' => '#5d95f6',
...
if (!isset($groupby) || empty($groupby) || $groupby=='daily') {
    $resumeGameData = statsUserPayersFecha($appid,$fechaOrigen,$fechaFinal,$country);
    $fieldName = 'tPayerFecha';
    $rowKey = 'Day';
}
else if ($groupby=='weekly') {
    $resumeGameData = statsUserPayersSemana($appid,$fechaOrigen,$fechaFinal,$country);
    $fieldName = 'tPayerSemana';
    $rowKey = 'Week';
}
else if ($groupby=='monthly') {
    $resumeGameData = statsUserPayersMes($appid,$fechaOrigen,$fechaFinal,$country);
    $fieldName = 'tPayerMes';
    $rowKey = 'Month';
}
...
if (!isset($scope) || empty($scope) || $scope=='daily') {
    $dropObject = 'TOTAL_PAYER_FECHA';
    $chartKey = 'Day';
}
else if ($scope=='weekly') {
    $dropObject = 'TOTAL_PAYER_SEMANA';
    $chartKey = 'Week';
}
else {
    $dropObject = 'TOTAL_PAYER_MES';
    $chartKey = 'Month';
}
...
#########################################################################
function statsUserPayersFecha($appid,$fechaOrigen,$fechaFinal,$country='ES'){
    ...
    if (isset($res->tPayerFecha->tPayerFechaRow) && is_array($res->tPayerFecha->tPayerFechaRow)) {
        $retorno['tPayerFecha'] = (array)$res->tPayerFecha->tPayerFechaRow;
    }
    else {
        $retorno['tPayerFecha'][0] = $res->tPayerFecha->tPayerFechaRow;
    }
    return $retorno;
}

function statsUserPayersSemana($appid,$fechaOrigen,$fechaFinal,$country='ES'){
    ...
    $retorno['result'] = $res->result;
    if (isset($res->tPayerSemana->tPayerSemanaRow) && is_array($res->tPayerSemana->tPayerSemanaRow)) {
        $retorno['tPayerSemana'] = (array)$res->tPayerSemana->tPayerSemanaRow;
    }
    else {
        $retorno['tPayerSemana'][0] = $res->tPayerSemana->tPayerSemanaRow;
    }
    return $retorno;
}

function statsUserPayersMes($appid,$fechaOrigen,$fechaFinal,$country='ES'){
    ...
    $retorno['result'] = $res->result;
    if (isset($res->tPayerMes->tPayerMesRow) && is_array($res->tPayerMes->tPayerMesRow)) {
        $retorno['tPayerMes'] = (array)$res->tPayerMes->tPayerMesRow;
    }
    else {
        $retorno['tPayerMes'][0] = $res->tPayerMes->tPayerMesRow;
    }
...
<div class="row">
	<div class="col-sm-12">	
		...
		<table id="dtPayer" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
		  <thead>
		  	...
		  	<tr>
		  		<th></th>
		  		<th>Total <br/><span style="font-size:9px">(<?php echo($supertotal);?> users)</span></th>
		  		<th><?php echo(number_format(($totales[0]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[0].' users)</span>'); ?></th>
		  		<th><?php echo(number_format(($totales[1]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[1].' users)</span>'); ?></th>
		  		<th><?php echo(number_format(($totales[2]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[2].' users)</span>'); ?></th>
		  		<th><?php echo(number_format(($totales[3]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[3].' users)</span>'); ?></th>
		  		<th><?php echo(number_format(($totales[4]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[4].' users)</span>'); ?></th>
		  		<th><?php echo(number_format(($totales[5]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[5].' users)</span>'); ?></th>
		  		<th><?php echo(number_format(($totales[6]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[6].' users)</span>'); ?></th>
		  		<th><?php echo(number_format(($totales[7]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[7].' users)</span>'); ?></th>
		  		<th><?php echo(number_format(($totales[8]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[8].' users)</span>'); ?></th>
		  		<th><?php echo(number_format(($totales[9]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[9].' users)</span>'); ?></th>
		  		<th><?php echo(number_format(($totales[10]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[10].' users)</span>'); ?></th>
		  		<th><?php echo(number_format(($totales[11]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[11].' users)</span>'); ?></th>
		  		<th><?php echo(number_format(($totales[12]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[12].' users)</span>'); ?></th>
		  		<th><?php echo(number_format(($totales[13]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[13].' users)</span>'); ?></th>
		  		<th><?php echo(number_format(($totales[14]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[14].' users)</span>'); ?></th>
		  		<th><?php echo(number_format(($totales[15]/$supertotal) * 100,2).'% <br/><span style="font-size:9px">('.$totales[15].' users)</span>'); ?></th>
		  	</tr>
  		  	...
  		  	if (isset($resumeGameData[$fieldName]) && count($resumeGameData[$fieldName])) {
  		  	    ...
  		  	    foreach ($resumeGameData[$fieldName] as $key => $value) {
    	  	        ...
    	  	        foreach ($value->$dropObject as $key2 => $value2) {
    	  	            ...
    	  	            $totalRow = $totalRow + $value->$dropObject[$key2];
    	  	        }
    	  	        ...
    	  	        echo('<tr>');
    	  	            ...
    	  	            $valorRow = number_format(($totalRow/$value->TOTAL_INSTALADOS) * 100,2);
    	  	            echo('<td>'.$valorRow .' % <br/><span style="font-size:9px">('.$totalRow.' users)</span></td>');
...
$( document ).ready(function() {
	...
	$('#search').click(function() {
		...
		window.location.href = "./payers.php?appid="+appid+"&from="+fechaDesde+"&to="+fechaHasta+"&country="+pais+"&source="+source+"&medium="+medium+"&scope="+scope+"&groupby="+groupby;
	...
	Highcharts.chart('global', {
    	...
    	title: {
    		text: '% of Users and Time taken to become a Paying User from date of registration'
		},
		navigator: {
            enabled: false
        },
	...
	// LOAD TABLE
	var table = $('#dtPayer').DataTable({"bFilter": false,"bPaginate": false,"bInfo": false});
