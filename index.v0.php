...
<head>
    ...
    <meta content="GameCharts Index Page. This page shows Top Games and Trending of Games by current players or average players. You can see the summary of individual game of each platfrom." name="description" />
    <meta name="keywords" content="plyer, game, chart, average, current, playerunknowns, 24-hours, platform, name, steam, idcgames, xbox, current players, average players, game chart." />
...
<div class="page-wrapper page-wrapper-img">
    <div class="page-wrapper-inner align-items-center position-relative">
        ...
        <div class="container-fluid px-0">
            <!-- desktop-screen-->
            <div class="row desktop-screen justify-content-center mb-5 pb-3">
                                            ...
                                            if(count($trending)) {
                                                ...
                                                foreach($trending as $data){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="./<?php echo($data["store"]); ?>"><img src="<?php echo($stores[$data["store"]]->Splash);?>" alt="<?php echo($stores[$data["store"]]->Store)?>" style="max-with:75px; max-height:30px"/></a>
                                            ...
                                            if(count($topdata)) {
                                                ...
                                                foreach($topdata as $data){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="./<?php echo($data->Store); ?>"><img src="<?php echo($stores[$data->Store]->Splash);?>"  alt="<?php echo($stores[$data->Store]->Store)?>" style="max-with:75px; max-height:30px"/></a></td>
                                ...
                                if(count($topdata)) {
                                    ...
                                    foreach($topdata as $data){
                                        ...
                                        <tr>
                                            <td><?php echo $index++?>.</td>
                                            <td><a class="text-dark" href="./<?php echo($data->Store); ?>/<?php echo ($data->NameSEO); ?>"><?php echo $data->Name?></a></td>
                                            <td><a href="<?php echo($stores[$data->Store]->Url);?>"><img src="<?php echo($stores[$data->Store]->Splash);?>" style="max-with:75px; max-height:30px"/></a></td>
                                            <td class="text-center"><?php echo number_format($data->LastCcu)?></td>
                                            <td class="text-center text-gray"><?php echo number_format($data->TopCcu24h)?></td>
                                            <td class="text-center text-gray"><?php echo number_format($data->TopCcu30d)?></td>
                                            <td class="text-center text-gray"><?php echo number_format($data->TopCcu)?></td>
                            ...
                            <?php foreach($trending as $data):?>
                                ...
                                <div class="row ml-4 mr-2">
                                    <div style="display: block; width: 100%" >
                                        <img class="img-thumnail" src="<?php echo ($i_game[0]->Splash);?>" />
                                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#trending_game_slider_mobile').bxSlider();
        $('#top_game_slider').bxSlider();
        $('#top_game_slider_mobile').bxSlider();
    })
</script>
</body>
</html>
